...
namespace DBGuard.Core.DAL.Migrations
{
    ...
    [Migration("20230929104151_UserManyToOneBranch")]
    partial class UserManyToOneBranch
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DBGuard.Core.DAL.Entities.ChangeRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DBGuard.Core.DAL.Entities.ProjectDatabase", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DBGuard.Core.DAL.Entities.Script", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DBGuard.Core.DAL.Entities.Branch", b =>
                {
                    ...
                    b.HasOne("DBGuard.Core.DAL.Entities.Branch", "ParentBranch")
                        .WithMany()
            ...
            modelBuilder.Entity("DBGuard.Core.DAL.Entities.Script", b =>
                {
                    ...
                    b.HasOne("DBGuard.Core.DAL.Entities.User", "LastUpdatedBy")
                        .WithMany()
