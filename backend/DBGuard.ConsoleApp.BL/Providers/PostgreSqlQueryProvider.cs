...
using static DBGuard.ConsoleApp.BL.SqlScripts.Postgres.GetTables;
using static DBGuard.ConsoleApp.BL.SqlScripts.Postgres.GetObjects;
using static DBGuard.ConsoleApp.BL.SqlScripts.Postgres.GetUserDefinedTypes;
