...
using static DBGuard.ConsoleApp.BL.SqlScripts.SqlServer.GetTables;
using static DBGuard.ConsoleApp.BL.SqlScripts.SqlServer.GetObjects;
using static DBGuard.ConsoleApp.BL.SqlScripts.SqlServer.GetUserDefinedTypes;

namespace DBGuard.ConsoleApp.BL.Providers;
